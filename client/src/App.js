        ...
        <div style={styles.flexOne}>
          ...
          <div style={styles.flexTwo}>
            <Switch>
              ...
              <ProtectedRoute exact path="/schools/:id" component={SchoolPage} />
              <ProtectedRoute exact path="/interviews" component={InterviewsPage} />
              <ProtectedRoute exact path="/new_interview" component={NewInterview} />
              <ProtectedRoute exact path="/interview/:id" component={IntPage} />
              <ProtectedRoute exact path="/courses" component={Courses} />
              <ProtectedRoute exact path="/courses/:id" component={CoursePage} />
